...
type confirmWithdrawalTransactionResponseBody struct {
	Status string `json:"status"`
}

func (handler *transactionHTTPRestHandler) ConfirmWithdrawalTransaction(ctx *gin.Context) {
	...
	err, statusCode = handler.transactionUsecase.ConfirmWithdrawalTransaction(
		authUserID,
		transactionUUID,
	)
	...
	ctx.JSON(int(statusCode), confirmWithdrawalTransactionResponseBody{Status: "Success"})
